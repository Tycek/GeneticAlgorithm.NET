...
public class StockInGeneticAlgorithm<T> where T : class, IEntity, new()
{
    ...
    public StockInGeneticAlgorithm(int numberOfIterations, int populationSize, double crossbreedProb, double mutationProb)
    {
    ...
    private void Evaluate(T entity)
    {
        entity.Fitness = 0;
